...
export default class Example19 extends Examples {
  ...
  create() {
    ...
    //dopo 2 secondi (una tantum, loop non specificato) richiamiamo il metodo flash
  ...
  //effetto "flash": la camera si illumina con il colore indicato e poi torna normale
