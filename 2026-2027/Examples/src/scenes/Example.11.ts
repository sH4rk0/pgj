...
export default class Example11 extends Examples {
  ...
  create() {
    ...
    console.log("Example 11 - Containers");
    ...
    this._text1 = this.add.text(512, 350, "Play").setDepth(10).setAlpha(0).setOrigin(.5).setFontSize(40).setFontFamily("Roboto").setInteractive()
      .on("pointerover", () => {
        this.sound.playAudioSprite("sfx", "coin", { loop: false, volume: .1, });
    ...
    this._text2 = this.add.text(512, 420, "Credits").setDepth(10).setAlpha(0).setOrigin(.5).setFontSize(40).setFontFamily("Roboto").setInteractive()
      .on("pointerover", () => {
        this.sound.playAudioSprite("sfx", "coin", { loop: false, volume: .1, });
      ...
      .on("pointerout", () => {
        ...
        this.sound.playAudioSprite("sfx", "key", { loop: false, volume: .2, });
        this.showCredits();
    ...
    this._close = this.add.text(512, 470, "Chiudi").setOrigin(.5).setFontFamily("Roboto").setFontSize(30)
      .on("pointerover", () => {
        this.sound.playAudioSprite("sfx", "coin", { loop: false, volume: .1, });
...
//on scene shutdown
  ...
  showCredits() {
    this.sound.playAudioSprite("sfx", "heart", { loop: false, volume: .2, });
