...
export default class Example17 extends Examples {
  ...
  create() {
    ...
    this.add.text(640,400,"Use arrows to move the camera").setFontFamily("Roboto").setColor("#ffffff").setStroke("#000000",6).setFontSize(40).setScrollFactor(0).setOrigin(.5)
