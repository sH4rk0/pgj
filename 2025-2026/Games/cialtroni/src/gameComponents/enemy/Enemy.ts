...
export default class Enemy
    ...
    protected _isCharging: boolean = false;
    protected _isSuperPower: boolean = false;
    ...
    isSuperPower(): boolean {
        return this._isSuperPower;
    }
    setSuperPower(value: boolean): void {
        this._isSuperPower = value;
    }
